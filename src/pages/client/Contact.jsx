      ...
      <div className="container grid grid-flow-row grid-cols-1 gap-y-5 sm:gap-y-0 sm:grid-flow-col sm:grid-cols-5 sm:gap-x-10">
        <div className="items-center col-start-1 sm:col-start-1 sm:col-end-4 border border-gray-300 rounded-sm">
          ...
          <p className="py-6 px-5 border-t text-sm text-gray_7a82a6 leading-7">
            Tên thật của mình là Đỗ Tấn Phát. Hiện tại đang học tại Đại học Công
            nghiệp thực phẩm. Có một sự thật thú vị rằng chỉ cần mình 101 tuổi
            thì mình sẽ là công dân của 3 thế kỉ. Vậy đố các bạn năm nay mình
            bao nhiêu tuổi?
            <br />
            ...
            luôn cố gắng để thực hiện được ước mơ đó; và cũng xin cảm ơn một bạn
            nữ đã tạo động lực cho mình. Lov u so much, Tama Câu nói truyền cảm
            hứng mình thích nhất:
            <br />
